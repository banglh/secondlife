# Scrapy settings for secondlife project
#
...
SPIDER_MODULES = ['secondlife.spiders']
NEWSPIDER_MODULE = 'secondlife.spiders'

# settings for pipelines
ITEM_PIPELINES = {
                  'secondlife.pipelines.RegionPipeline': 100 
                  }
...
#USER_AGENT = 'secondlife (+http://www.yourdomain.com)'
